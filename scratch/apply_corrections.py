...
# Let's draft the exact updated markdown incorporating all 11 corrections strictly against Wikipedia Therac-25 text
...
These overexposures caused severe tissue necrosis, loss of limb function, internal organ destruction, and three direct patient deaths. Unlike traditional industrial accidents caused by exploding pressure vessels or structural failures, the catastrophes of the Therac-25 occurred quietly inside the silicon logic of a PDP-11 minicomputer. The machine appeared to function normally from the operator's console, even as it delivered lethal radiation into living tissue.
...
Between June 1985 and January 1987, six distinct radiation overexposure incidents occurred across four medical facilities documented in the Wikipedia record: Kennestone Regional Oncology Center, the Ontario Cancer Foundation, East Texas Cancer Center in Tyler, Texas, and Yakima Valley Memorial Hospital in Yakima, Washington.

### June 3, 1985: Kennestone Regional Oncology Center

The first recorded Therac-25 accident occurred on June 3, 1985, at Kennestone Regional Oncology Center (located in Marietta, Georgia, as documented in regional medical records). A 61-year-old female patient, Katie Yarbrough, was receiving follow-up radiation therapy following a lumpectomy for breast cancer. Her treatment plan prescribed a 200-rad (2 Gy) electron beam treatment to her collarbone area.
...
Seven weeks after the Marietta incident, on July 26, 1985, a second overexposure occurred at the Ontario Cancer Foundation clinic (commonly referenced in Hamilton, Ontario). A 40-year-old female patient was undergoing her twenty-fourth radiation treatment for cervical cancer.

The operator set up the Therac-25 for an electron treatment. When the machine activated, it ran for a fraction of a second before shutting down with an error message reading "H-tilt". The console displayed a code indicating that no dose had been delivered. The operator pressed the proceed key to resume treatment, and the machine faulted again with the same error code. This process was repeated five times before the machine was stopped.
...
No specific overdose dose figure was documented in the source record for this incident, but Hewitt received an unattenuated high-current electron beam directly to his face and head. He described hearing a loud noise and seeing a bright light before experiencing severe facial pain. Hewitt died on May 1, 1986, three weeks after the exposure. An autopsy subsequently revealed severe, acute radiation damage to his right temporal lobe and brain stem. He was the second patient to die directly from a Therac-25 overdose.
...
The operator administered the two film alignment exposures. He then entered the treatment room to adjust the patient's position and remove the film cassette holder. However, he forgot to remove the film cassette holder from the machine head.

Returning to the console, the operator initiated parameter entry. During the setup process, the shared variable counter in the `SetUpTest` subroutine underwent an 8-bit arithmetic overflow, wrapping around to 0 at the exact moment he pressed 'Set'. The software bypassed its turntable alignment check, failing to detect that the turntable was positioned in field-light mode.
...
The turning point in unmasking the truth occurred after the second Tyler, Texas incident in April 1986. The hospital physicist and staff at East Texas Cancer Center refused to accept AECL's claim that the machine could not malfunction. The hospital physicist shut down the machine and spent days attempting to replicate the exact sequence of events.

Knowing that the operator was exceptionally fast at data entry, the hospital physicist sat at the VT100 terminal and repeatedly entered treatment parameters at high speed, experimenting with rapid cursor up editing between X-ray and Electron modes. After dozens of attempts, the hospital physicist successfully reproduced "Malfunction 54." This proved that rapid typing forced the software into an unattenuated high-current beam state while displaying a false low-dose screen.

The hospital physicist immediately notified AECL and the United States Food and Drug Administration (FDA). Faced with undeniable empirical proof, AECL could no longer attribute overdoses to operator error or localized electrical glitches.

## Regulatory Action, Re-engineering, and Industry Lessons

Following the empirical replication of the software bug in 1986, the FDA declared the Therac-25 defective and ordered AECL to submit a Corrective Action Plan (CAP). The FDA rejected AECL's initial proposed revisions as inadequate, forcing the corporation to undertake a complete redesign of the machine's safety architecture.

Under regulatory supervision, AECL made fundamental structural modifications to all Therac-25 units:
...
- [x] **Case 1 (Marietta, GA / Kennestone):** June 3, 1985 at Kennestone Regional Oncology Center (Marietta, GA); patient Katie Yarbrough; received estimated 15,000 to 20,000 rad; severe burn, breast removal, frozen shoulder, arm loss of use; survived. *(Source: Wikipedia Therac-25 Incidents section)*
- [x] **Case 2 (Hamilton, Ontario / Ontario Cancer Foundation):** July 26, 1985 at Ontario Cancer Foundation (Hamilton, ON); 40-year-old female patient; estimated 13,000 to 17,000 rad overdose; H-tilt error code; died November 3, 1985 (autopsy listed cancer as primary cause, with overdose complications noted). *(Source: Wikipedia Therac-25 Incidents section)*
...
- [x] **Case 4 (Tyler, TX - March 1986):** March 21, 1986 at East Texas Cancer Center; patient Ray Cox; mode selection editing bug; Malfunction 54 displayed; Cox described sensation as "an intense electric shock"; prescribed dose 180 rad (1.8 Gy); received estimated 16,500 to 25,000 rad; died five months after overdose (Overdose death #1). *(Source: Wikipedia Therac-25 Incidents section)*
- [x] **Case 5 (Tyler, TX - April 1986):** April 11, 1986 at East Texas Cancer Center; patient Verdon Hewitt; facial skin cancer treatment; Malfunction 54 displayed; no specific overdose amount documented in source; died May 1, 1986; autopsy showed severe radiation damage to right temporal lobe and brain stem (Overdose death #2). *(Source: Wikipedia Therac-25 Incidents section)*
- [x] **Case 6 (Yakima, WA - 1987):** January 17, 1987 at Yakima Valley Memorial Hospital; scheduled for 86 rad total; male operator forgot to remove film cassette; counter overflow bug occurred; received estimated 8,000 to 10,000 rad; died April 1987 (Overdose death #3). *(Source: Wikipedia Therac-25 Incidents section)*
- [x] **Tyler Investigation:** The hospital physicist and staff successfully reproduced "Malfunction 54" by typing quickly at the console, proving software defect to AECL and FDA. *(Source: Wikipedia Therac-25 History & Incidents sections)*
- [x] **Regulatory & Corrective Actions:** FDA declared Therac-25 defective in 1986, mandated Corrective Action Plan (CAP), restored physical hardware interlocks, overhauled assembly code, added hardware beam shutoffs, and clarified error messages. *(Source: Wikipedia Therac-25 Aftermath section)*
"""

# Let's verify no em dashes anywhere in article_content
dashes_found = re.findall(r'—|--|&mdash;|–', article_content.replace('---', ''))
print("Prose em/en/double-hyphen dash count:", len(dashes_found))

target_path = r"d:\MyWeb\Night Lore\src\content\stories\therac-25-radiation-accidents.md"
with open(target_path, "w", encoding="utf-8") as out_f:
    out_f.write(article_content)
print("Updated file saved to:", target_path)
